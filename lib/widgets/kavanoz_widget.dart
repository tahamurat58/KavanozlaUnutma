...
class KavanozWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Tatlı bir giriş (pop) animasyonu
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: karanlikTema ? const Color(0xFF5D4037) : const Color(0xFF6D4C41),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: karanlikTema
                    ? [const Color(0x44546E7A), const Color(0x6690A4AE), const Color(0x44546E7A)]
                    : [const Color(0x44BBDEFB), const Color(0x77E3F2FD), const Color(0x44BBDEFB)],
              ),
              border: Border.symmetric(
                vertical: BorderSide(
                  color: karanlikTema ? const Color(0xFF546E7A) : const Color(0xFF90CAF9),
                  width: 2,
                ),
              ),
            ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: karanlikTema
                    ? [const Color(0x33546E7A), const Color(0x2278909C), const Color(0x33546E7A)]
                    : [const Color(0x55BBDEFB), const Color(0x33E3F2FD), const Color(0x55BBDEFB)],
              ),
              borderRadius: const BorderRadius.only(
              ...
              boxShadow: [
                BoxShadow(
                  color: karanlikTema ? Colors.amber.withValues(alpha: 0.08) : Colors.blue.withValues(alpha: 0.1),
                  blurRadius: 20,
                  spreadRadius: 4,
                ),
                BoxShadow(
                ...
                Column(
                  ...
                  children: [
                    Icon(
                      Icons.auto_stories,
                      size: 44,
                      color: karanlikTema ? Colors.amber.shade300 : Colors.amber.shade700,
                    ),
